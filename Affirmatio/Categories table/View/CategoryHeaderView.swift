...
class CategoryHeaderView: UITableViewHeaderFooterView {
    ...
    func configureContent() {
        ...
        NSLayoutConstraint.activate([
            ...
            container.widthAnchor.constraint(equalTo: contentView.widthAnchor, multiplier: 0.95), //(equalTo: contentView.layoutMarginsGuide.widthAnchor),
            ...
            //container.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: 40),
